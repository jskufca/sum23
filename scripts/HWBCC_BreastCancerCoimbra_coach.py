...
print(timeit.timeit("mdl2.fit(X_train,y_train)",number=10,globals=globals()))
...
print(timeit.timeit("mdl3.fit(X_train,y_train)",number=10,globals=globals()))
...
print(timeit.timeit("mdl4.fit(X_train,y_train)",number=10,globals=globals()))
...
#%% Using tranformers with output as pandas dataframe
